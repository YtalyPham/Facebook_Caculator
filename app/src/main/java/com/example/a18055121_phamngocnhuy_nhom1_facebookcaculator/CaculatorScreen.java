...
public class CaculatorScreen extends AppCompatActivity {
    Button btnDiv,btnAdd,btnSub,btnMulti,btnBack,btnClear;
    EditText txtA,txtB;
    TextView txtResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caculator_screen);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                stopAnimation();
                Intent intent = new Intent(CaculatorScreen.this,MainActivity.class);

                ActivityOptionsCompat optionsCompat=ActivityOptionsCompat.makeSceneTransitionAnimation(
                        CaculatorScreen.this,btnBack,
